              ...
              <div className="row wrapper" style={{ height: "86vh" }}>
                ...
                <div className="inst">
                  <ol type="1" className="list">
                    <li> The contest is best viewed in full-screen and 1366x768 resolution settings. We suggest that you change your display settings temporarily, in order to enhance your experience.</li>
                    <li>Make sure you have a stable internet connection for the next two hours.</li>
                    <li>Refreshing the page at any point during the game will cause loss of your data, which cannot be retrieved. We thereby advice you to abstain from such practices.</li>
                    <li>Each question has 100 points.</li>
                    <li>Duration of the contest is 2 hours.</li>
                  </ol>
