...
export default function NavDivs(props) {
  ...
  else if (imgSrc === "/Question.png") division = "Question Hub";
  else if (imgSrc === "/iconLeader.png") division = "Leaderboard";
  else if (imgSrc === "/submissions.png") division = "Submissions";
  else division = "Log Out";
