...
class Testcases extends Component {
    ...
    numberBorder=(testcase)=>{
        let classes="number ";
        classes=testcase==="pass"?classes+"border border-success":classes+"border border-danger";
        return classes;
    }
    render() { 
        return (
        ...
        <div className="row" style={{height:"55vh"}}>
           <div className="col-lg-7" style={{marginLeft:"4vw"}}>
               <div className="row" style={{display:"flex",justifyContent:"center",height:"54vh",alignItems:"center"}}>
                ...
                <div className="col-lg-1" style={{border:".5px solid rgb(39, 40, 43)"}}></div>
                <div className="col" style={{borderLeft:"1px solid rgb(39, 40, 43)",height:"40vh"}}>
    
                        {this.state.testcases.map((testcase,index) => 
                        <div className="row" style={{height:"8vh"}}>
                            <div className="testcaseLines col-lg-2"/>
                            <div className={this.numberBorder(testcase)}>{index+1}</div>
