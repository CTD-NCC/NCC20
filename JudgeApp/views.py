...
def get_signals_dict():
    signals = {
        ...
        # All of these codes(exit codes of a process)cle are of the format 128 + signal code generated by child process
...
def get_quota(qno, ext, test_case_no):
    if test_case_no == 7:
        test_case_no = 6
    if ext != 'py':
...
def run_test_case(test_case_no,code_f_path, user_que_path, ext, qno):
    ...
    quota = get_quota(qno, ext, test_case_no)
